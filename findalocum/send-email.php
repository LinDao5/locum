...
$email=$_POST["email"];
  ...
  @$speReq=$_POST["speReq"];
if($contactname== "" || $contactname== NULL){echo "<script>alert('Please Enter Contact Name');</script>";}
...
elseif($date == "" || $date == NULL){echo "<script>alert('Please Enter Date');</script>";}
 ...
 $subject="Independent booking request";
...
$headers .= 'From: <no-reply@localhost.com>';
   ...
   if(mail($receiver,$subject,$message,$headers))  
   {
      header("Location: http:/ec2-18-163-113-25.ap-east-1.compute.amazonaws.com/findalocum/thanks.html");
