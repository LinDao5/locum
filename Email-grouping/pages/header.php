...
$link = $_GET['pages'];
$acc = $_SESSION['acc'];
$getUser = mysqli_query($conn,"SELECT * FROM users WHERE UserName='$acc'");
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo $site_url; ?>/mailing">Send Mails</a>
            <?php if($user['State'] == 1){ ?>
            <a class="collapse-item" href="<?php echo $site_url; ?>/mail-list">Edit Mail List</a>
            <a class="collapse-item" href="<?php echo $site_url; ?>/add-list">Add Mail List</a>
            <a class="collapse-item" href="<?php echo $site_url; ?>/add-mail">Add New Mail</a>
            <?php } ?>
          </div>
        </div>
      </li>
...
<li class="nav-item">
  ...
  <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="<?php echo $site_url;?>/add-user">Add User</a>
      <a class="collapse-item" href="<?php echo $site_url;?>/edit-user">Edit User</a>
    </div>
  </div>
</li>
<?php } ?>
